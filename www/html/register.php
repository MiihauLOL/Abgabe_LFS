...
<div class="service">
		...
		<div class="box">
			...
			<div class="login">
				<form action="register.inc.php" method="post">
					<input type="text"  name="name"  placeholder="Enter Your Full Name"></center>
					  </br>	</br>	
         <input type="text"  name="email"  placeholder="Enter Your Email"></center>
      	...
      	<input type="password"  name="pwd2"  placeholder="Repeat Your Password">
  ...
  if(isset($_GET["error"])){
    ...
    echo "<h6>Fuellen Sie alle Felder! </h6>";
     ...
     echo "<h6>Geben Sie eine richtige Email Adresse ein! </h6>";
    }
     else if($_GET["error"]=="passwordsdontmatch"){
     echo "<h6>Die Passwoerter stimmen nicht ueber ein!</h6>";
    }
     else if($_GET["error"]=="emailtaken"){
     echo "<h6>Ein Nutzer mit dieser Email Adresse existiert bereits! </h6>";
    }
    else if($_GET["error"]=="none"){
     echo "<h6>Sie haben sich erfolgreich Registriert! </h6>";
    }
